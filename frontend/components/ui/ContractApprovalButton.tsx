          ...
          <div className="bg-white rounded-xl shadow-2xl max-w-md w-full max-h-[85vh] flex flex-col">
            ...
            <div className="flex-1 overflow-y-auto p-4 sm:p-6 space-y-4">
              ...
              {(() => {
                ...
                if (!contract.inscripcion_arl) missingFields.push('Inscripción ARL')
                ...
                if (!contract.confirmacion_eps) missingFields.push('Confirmación EPS')
                if (!contract.envio_inscripcion_caja) missingFields.push('Envío inscripción caja')
                if (!contract.confirmacion_inscripcion_caja) missingFields.push('Confirmación inscripción caja')
